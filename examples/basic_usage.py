"""
Basic usage example for Hubspot MCP Server.
...
Prerequisites:
- Install the package: pip install hubspot-mcp-server
...
async def example_usage():
    """
    Example usage of Hubspot MCP Server.
...
if __name__ == "__main__":
    ...
    print("\n" + "="*60)
    print(f"  Hubspot MCP Server - Basic Usage Example")
    print("="*60 + "\n")
    ...
    try:
        ...
        print("2. All dependencies are installed: pip install hubspot-mcp-server")
